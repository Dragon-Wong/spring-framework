 ...
 *
 *
 * 主要处理 @Resource、@PostConstruct 和 @PreDestory 注解的实现
 * Resource的处理由他自己完成
 * 其他两个由他的父类完成
 * 父类 InitDestroyAnnotationBeanPostProcessor 的 postProcessMergedBeanDefinition 会找出被 @PostConstruct 和 @PreDestory
 * 注解修饰的方法
 */
...
public class CommonAnnotationBeanPostProcessor extends InitDestroyAnnotationBeanPostProcessor
	...
	public void postProcessMergedBeanDefinition(RootBeanDefinition beanDefinition, Class<?> beanType, String beanName) {
		// 获取所有添加了 @PostContract 或 @PreDestroy 注解的方法，并做记录
		super.postProcessMergedBeanDefinition(beanDefinition, beanType, beanName);
		// 获取所有添加了 @WebServiceRef 或 @EJB 或 @Resource 注解的方法或属性
